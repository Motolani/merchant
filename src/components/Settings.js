...
import { IconButton, MD3Colors, Divider, PaperProvider, Switch, TextInput, Button} from 'react-native-paper';
...
const Settings = ({ navigation }) => {
    const { msisdn, userToken, signOut, name } = useContext(AuthContext);
                ...
                <ScrollView> 
                    ...
                    <View style={[styles.bluetoothBox]}>
                        ...
                        <View style={styles.inputWrapper}>
                            ...
                            Icon={() => {
                                return <Ionicons name={'print'} size={22} color={'#17375e'} />;
                            }}
                            />
                        </View>
